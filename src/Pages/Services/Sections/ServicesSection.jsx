    ...
    <section className="">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl md:text-5xl lg:text-[56px] font-bold">
          See Our{" "}
          <span className="inline-block"> Services<div className="-mt-3 h-3 w-full bg-[var(--accent-yellow)]"></div></span> 
        </h2>
        <p className="text-gray-600 my-8 max-w-2xl text-xl mx-auto">
          We will help the client’s problems to develop the products they have
          with high quality Change the appearance. Prove the ROI of social
          media, plan more.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Task Management */}
          <div className="card bg-white hover:bg-purple-50 shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
          ...
          <div className="card bg-white hover:bg-purple-50 shadow-lg rounded-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Help create a website and redesign it so that it becomes a website
              that is more trendy and looks fresh
            </p>
          </div>
          ...
          <div className="card bg-white hover:bg-purple-50 shadow-lg rounded-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Change the appearance of a design into amazing website that will
              be made into an attractive code
            </p>
          </div>
          ...
          <div className="card bg-white hover:bg-purple-50 shadow-lg rounded-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Create a 3d video animation in a short period of time targeted to
